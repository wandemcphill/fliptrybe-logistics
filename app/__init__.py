...
# 🟢 INITIALIZE CELERY GLOBALLY: This prevents 'NoneType' errors during worker startup
...
def create_app():
    ...
    # Render Persistent Disk Pathing for SQLite (Fallback)
    ...
    # Task context bridging: Allows Celery tasks to access the Database
